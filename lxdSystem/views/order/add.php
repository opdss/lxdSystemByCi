                ...
                <div class="container">
                    <form class="new_user_form">
                        <div class="col-md-4 field-box" style="width:800px;">
                            ...
                            <input class="form-control" type="text" style="width: 422px;" placeholder="订单名称" name="order_name" />
                        ...
                        <div class="col-md-12 field-box" style="width:800px;">
                            ...
                            <input class="form-control" type="text" style="width: 422px;" placeholder="订单委托商" name="order_jiafang"/>
                        ...
                        <div class="col-md-6 field-box" style="width:800px;">
                            ...
                            <span class="alert-msg validate_date" style="color: #995300;font-weight:700;" hidden="hidden"><img src="../../source/img/myimg_question.png" style="width:20px;" />完成时间比开始时间还要早么？</span>
                        </div>
                        <div class="col-md-4 field-box" style="width:800px;">
