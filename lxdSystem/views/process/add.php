                    ...
                    <form class="new_user_form">
                        <div class="col-md-12 field-box clone_process_div" style="width:800px;">
                            ...
                            <div class="address-fields"">
                                ...
                                <span class="alert-msg validate_is_null validate_process" style="color:red;font-weight:700;" hidden="hidden"><img src="<?php echo base_url('source/img/gif/01.gif'); ?>" style="width:40px;" />把这个工序先填完</span>
                                <span class="alert-msg validate_is_num" style="color:red;font-weight:700;" hidden="hidden"><img src="<?php echo base_url('source/img/myimg_fadai.png'); ?>" style="width:20px;" />写错了吧？？</span>
